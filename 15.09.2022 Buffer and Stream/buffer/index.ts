...
const uit32array = new Uint32Array(buf4); // создание полноценного массива из, в данном случае 4 байтов
console.log(uit32array);

const array = new Uint16Array(20);
const buf5 = Buffer.from(array.buffer, 0, 16); // добавление байтов
